...
from Dawin3D-S.modules.mink_layers import MinkConvBNRelu, MinkResBlock
from Dawin3D-S.modules.dawin3d2_layers import GridDownsample, GridKNNDownsample, BasicLayer, Upsample
...
class Dawin3D2Encoder(nn.Module):
