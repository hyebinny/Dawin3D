...
from Dawin3D_L.modules.mink_layers import MinkConvBNRelu, MinkResBlock
from Dawin3D_L.modules.dawin3d3_layers import GridDownsample, GridKNNDownsample, BasicLayer, Upsample
...
class Dawin3D_LEncoder(nn.Module):
