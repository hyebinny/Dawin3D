...
from Dawin3D_S.modules.mink_layers import MinkConvBNRelu, MinkResBlock
from Dawin3D_S.modules.dawin3d2_layers import GridDownsample, GridKNNDownsample, BasicLayer, Upsample
...
class Dawin3D_SEncoder(nn.Module):
