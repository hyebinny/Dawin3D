...
from Dawin3D_S.modules.mink_layers import (
    assign_feats,
    SparseTensorLayerNorm,
    SparseTensorLinear,
)
from Dawin3D_S.sparse_dl.attn.attn_coff import (
    SelfAttnAIOFunction,
    PosEmb,
    TableDims,
    IndexMode,
...
import Dawin3D_S.sparse_dl.knn
from Dawin3D_S.sparse_dl.knn import KNN
...
class SwinTransformerBlock(nn.Module):
    def __init__(
        ...
        self.dim = dim  ## C
        # self.window_size = [window_size, window_size + 2]
        self.window_size = [window_size, 2 * window_size]
